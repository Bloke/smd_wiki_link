...
The smd_wiki_link tag accepts a @text@ attribute to custommise the anchor text link. It defaults to 'Create article'. You may also use a @form@ or provide some container content to populate the anchor text.
